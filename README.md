...
O **CompStat Municipal** é o modelo de gestão por resultados adotado pela Prefeitura do Rio de Janeiro para orientar a atuação da **Força Municipal (FM)** nas 22 áreas prioritárias da cidade. Semanalmente, analistas de segurança cruzam dados de ocorrências, denúncias, fatores urbanos e inteligência de campo para produzir relatórios que direcionam o emprego dos 600 agentes em campo.
...
O analista deixa de ser um montador de planilhas e passa a atuar como **curador de inteligência**: valida, refina e decide com base em análises que a plataforma entrega prontas.
